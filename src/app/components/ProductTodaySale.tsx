      ...
      <div key={item.id} className="grid grid-cols-13 bg-white">
        ...
        <div className="flex flex-col col-span-7 px-8.5 pbe-8.5 pbs-17 text-left">
          <dl>
            ...
            <dd aria-label={`${item.category}`} className="text-[#7B7979] font-extrabold">
              {item.category}
            </dd>
          ...
          <div>
            <Link
              ...
              className="inline-flex px-6 py-2.5 text-white font-bold bg-[#FF6B6B] cursor-pointer rounded-2xl"
            >
