...
export default function RecommendMD({ products, maxProducts }: RecommendMDProps) {
  ...
  return (
    <>
      ...
      <button type="button" aria-disabled={moreButton} onClick={moreProduct} className="flex justify-center w-full m-auto max-w-70 font-bold rounded-2xl mbs-15 px-3 py-3 text-white bg-[#FF6B6B] aria-disabled:hidden cursor-pointer">
