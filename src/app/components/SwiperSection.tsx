...
export default function SwiperList({ swiperList }: swiperProps) {
  return (
    <Swiper
      ...
      className="
        [&_.swiper-pagination-bullets]:bottom-10!
        [&_.swiper-pagination-bullet]:bg-white!
        [&_.swiper-pagination-bullet]:opacity-100!
        [&_.swiper-pagination-bullet]:transition-all
        [&_.swiper-pagination-bullet]:duration-400 
        
        [&_.swiper-pagination-bullet-active]:bg-[#FF6B6B]!
        [&_.swiper-pagination-bullet-active]:w-16!
        [&_.swiper-pagination-bullet-active]:rounded-full!
        
        [&_.swiper-navigation-icon]:text-black
        [&_.swiper-button-next]:bg-white
        [&_.swiper-button-next]:p-3.5
        [&_.swiper-button-next]:ps-4.5
        [&_.swiper-button-next]:rounded-full
        [&_.swiper-button-next]:shadow-lg
        [&_.swiper-button-next]:right-5!

        [&_.swiper-button-prev]:bg-white
        [&_.swiper-button-prev]:p-3.5
        [&_.swiper-button-prev]:pe-4.5
