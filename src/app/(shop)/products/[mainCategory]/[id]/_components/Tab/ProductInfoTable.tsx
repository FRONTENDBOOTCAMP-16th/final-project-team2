const ProductInfoTable = () => {
  return (
    <table className="m-auto w-full max-w-7xl border-t border-b border-t-gray-200 border-b-gray-200">
      <tbody>
        <tr className="border-b border-b-gray-200">
          <th className="w-32 bg-gray-50 px-4 py-3 text-left text-gray-500">
            재질
          </th>
